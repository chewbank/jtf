...
module.exports = {
   ...
   fileTree(file) {
      ...
      const result = common.require('package.json')
      ...
      // try {
      //   beforePath = require.resolve("test/before.js");
      // } catch (error) {
      ...
      // try {
      //    afterPath = require.resolve("test/after.js");
      //  } catch (error) {
   ...
   loadsPath(loads) {
      ...
      for (let key in loads) {
         loads[key] = path.join(common.cwd, loads[key])
      }
